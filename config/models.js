...
module.exports.models = {
     ...
     ***************************************************************************/
    /**
     * Todo: in server first create all database and then run in dev mode
     */
    migrate: 'alter',
    ...
    attributes: {
        ...
        id       : { type: 'string', columnName: '_id', unique: true }, // this is for mongodb

        creator: { model: 'user' } // self creator
    ...
    dataEncryptionKeys: {
        default: '8rbu4Iyd9jmUleUQw8GhUmerhyK0JKwOCJCxqAsaWLE='
    },
